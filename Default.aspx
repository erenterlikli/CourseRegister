...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="Form1" runat="server">
        ...
        <div class="form-group">
            ...
            <asp:Label  runat="server" Text="Öğrenci Kayıt Formu" Font-Bold="True" Font-Size="18pt" Font-Italic="False" ></asp:Label>
                </div>
        ...
        <asp:Button ID="Button1" runat="server" Text="Kaydet" OnClick="Button1_Click" CssClass="btn btn-success" Height="40px" Width="150px" />
    </form>
</asp:Content>
